...
class UpdateCompanyProfileModel extends UpdateCompanyProfileResponse {
  const UpdateCompanyProfileModel({
    required super.status,
    required super.message,
    required super.data,
  });

  factory UpdateCompanyProfileModel.fromJson(Map<String, dynamic> json) =>
