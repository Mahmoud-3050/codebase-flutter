...
class UpdateCompanyUserProfileCubit extends Cubit<UpdateCompanyUserProfileState> {
  ...
  UpdateCompanyUserProfileCubit(this.updateCompanyUserProfileUseCase) : super(const UpdateCompanyUserProfileInitialState());
  ...
  Future<void> fUpdateCompanyUserProfile({
   ...
   required String image,
    ...
    final Either<Failure, UpdateCompanyUserProfileResponse> eitherResult = await updateCompanyUserProfileUseCase(UpdateCompanyUserProfileParams(
      firstName: firstName,
    ...
    eitherResult.fold((Failure failure) {
      emit(UpdateCompanyUserProfileErrorState(message: failure.message?? Strings.pleaseTryAgainLater));
