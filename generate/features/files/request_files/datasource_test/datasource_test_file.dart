...
class DatasourceTestFile extends RequestFile {
  ...
  Future<void> generate({required Names featureNames, required Request request}) async {
    ...
    ///--> File imports
    buffer.writeln(request.buffers.datasourceTest.generateImports(
    ...
    ///--> Test body
    buffer.writeln(request.buffers.datasourceTest.generateBody(featureNames: featureNames, request: request).toString());
